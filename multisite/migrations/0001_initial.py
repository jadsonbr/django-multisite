    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_canonical', models.BooleanField(null=True, default=None, validators=[multisite.models.validate_true_or_none], editable=False, help_text='Does this domain name match the one in site?', verbose_name='is canonical?')),
